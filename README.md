...
>
> Subnet may be changed in `http://192.168.<current interface>.2/fta/index.html?url=/engdata` (if using default configuration, [click here](http://192.168.32.2/fta/index.html?url=/engdata)). Username is `vzw` and password is `mbbdiag`.
>
> Same subnet settings may be attempted if interface IP is different, but it's not tested.
